...
$Version = (Get-Item bin\x64\RhubarbGeekNzInprocServer32.dll).VersionInfo.ProductVersion
$PackageId = 'rhubarb-geek-nz.InprocServer32'
...
try
{
	...
	Copy-Item 'disptlb\bin\x86\RhubarbGeekNzInprocServer32.dll' 'base\lib\netstandard2.0\RhubarbGeekNzInprocServer32.dll'
